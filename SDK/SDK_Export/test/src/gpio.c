...
void Initialize()
{
    XGpio_Initialize(&Dips, XPAR_SWITCH_DEVICE_ID);
    ...
    XIntc_Enable(&intCtrl, XPAR_AXI_INTC_0_SWITCH_IP2INTC_IRPT_INTR);

    XIntc_Connect(&intCtrl, XPAR_AXI_INTC_0_BUTTON_IP2INTC_IRPT_INTR,
        (XInterruptHandler)PushBtnHandler, (void *)0);
    XIntc_Connect(&intCtrl, XPAR_AXI_INTC_0_SWITCH_IP2INTC_IRPT_INTR,
